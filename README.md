...
| フォルダ | 内容 |
|----------|------|
| [Nextjs](./Nextjs/) | Next.js App Router + TypeScript のベストプラクティス |
...
## Git で使うパス（このリポジトリで作業するとき）

ターミナルでこのリポジトリに移動するときは、次のパスを使います。

```bash
cd /Users/fukumotoryou/Desktop/work/docs
```

- 初回のコミット・プッシュや、今後の `git status` / `git add` / `git commit` / `git push` は、上のように `cd` したあとで実行してください。
